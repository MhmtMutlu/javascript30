...
const sortedLife = inventors.sort((a, b) =>  (b.passed - b.year) - (a.passed - a.year))
console.table(sortedLife);

//? 6. create a list of Boulevards in Paris that contain 'de' anywhere in the name
// working on this page -> https://en.wikipedia.org/wiki/Category:Boulevards_in_Paris

// const categoryDOM = document.querySelector(".mw-category");
// // const linksDOM = Array.from(categoryDOM.querySelectorAll("a"));
// const linksDOM = [...categoryDOM.querySelectorAll("a")];
// const includesDeArray = linksDOM.map(item => item.textContent).filter(name => name.includes("de"));
